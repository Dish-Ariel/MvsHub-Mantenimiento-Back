class MessagesDTO:
	...
	ERROR_SUSCRIBER_NOT_FOUNDIN_SES= "ERROR_SUSCRIBER_NOT_FOUNDIN_SES"
	...
	ERROR_EMAIL_ALREADY_EXISTIN_BD= "TIPO DE FALLA:ERROR EN EL CORREO ELECTRONICO Buen día Tanto el correo nuevo como el antiguo ya existen en bd, favor de verificar sus datos. Saludos"
	ERROR_UPDATEIN_BD= "ERROR_UPDATEIN_BD"
	ERROR_CANNOT_DELETE_ONLY_UPDATE = "Buen día Debido a que la cuenta es source telmex o source dish con una compra no puede ser eliminada Saludos"
	...
	ERROR_WITH_LAMBDA="ERROR_WITH_LAMBDA"
